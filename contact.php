...
if (isset($_POST['submit'])) {
    ...
    if (empty($fullname)) {
        ...
        if ($db->insertRow("INSERT INTO contact(fullname, phone, email, subject, message) VALUES(?, ?, ?, ?, ?)", [$fullname, $phone, $email, $subject, $message]) == TRUE){
...
$result = $db->getRows("SELECT * FROM contact");
